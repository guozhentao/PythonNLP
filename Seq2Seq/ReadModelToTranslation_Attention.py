...
"""一下程序为解码过程"""
# 读取checkpoint的路径。9000表示训练程序在第200步保存的checkpoint
CHECKPOINT_PATH = './checkpoint_model/attention_ckpt-200'
...
class NMTModel(object):
    ...
    def inference(self, src_input):
        ...
        with tf.variable_scope('encoder'):
            enc_outputs, enc_state = tf.nn.bidirectional_dynamic_rnn(self.enc_cell_fw, self.enc_cell_bw, inputs=src_emb,
        ...
        with tf.variable_scope('decoder'):
            ...
            # 把解码器的循环神经网络self.dec_cell和attention封装成更高级的循环神经网络
